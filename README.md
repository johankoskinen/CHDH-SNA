...
Before the workshop, I would expect you to have looked through the INTRO tutorial (if not actually done some of the coding). In particular, *open up CHDH-SNA-INTRO.html*, navigate through these sections
* Overview
* Adjacency matrix
* Network Position
