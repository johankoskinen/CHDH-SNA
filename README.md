...
1. Social influence in cross-sectional network data
2. Auto-logistic Actor Attribute Models - Advanced topics
3. Modelling Social Influence with Panel Network Data (SAOMs)
4. Advanced Modelling of Social Influence with Panel Network Data
...
using the menue bar on the laft-hand side. You can then dip into these issues by trying out the code, either by copy-pasting from the html or by downloading and opening up CHDH-SNA-INTRO.Rmd. 

> Concepts like *edges*, *degree*, *density*, *triad*, etc, are fundamental to our understanding of network structure.

Refer to the slide deck for an overview.
