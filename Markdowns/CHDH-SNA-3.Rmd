...
#### FOR running multiSiena I had to download and install
### install.packages("~/RSiena.tar.gz", repos = NULL, type="source")
...
```{r s50estimsimpbert, results='hide', message=FALSE}
...
If you estimate a model with `siena07` and set `returnDeps=TRUE`, the answer object returns the simulations from Phase 3. Let us try with the model for `s50` from `CHDH-SNA-1.Rmd`.

### Setting up s50

```{r loads50a, results='hide'}
