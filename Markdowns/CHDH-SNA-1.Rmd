...
take into account how many ties people have. Leenders (2002) propose a
number of ways in which we can scale the adjacency matrix. Here we want
...
The *network autocorrelation* model, or *network disturbances* model,
...
the vector of disturbances \$\epsilon =
(\epsilon\_1,\ldots,\epsilon\_n)\^{\top} \$ as
...
the outcome variable* $Y$. This subtly different from correlation only
...
We may or may not see increased corrlation in the outcomes. Running 100
