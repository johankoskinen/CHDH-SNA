...
For each network we read in, we will 
1. Download it,
2. Format it, and 
3. plot it, 
so that we can later work with them as well as calculating some summary statistics for the networks. 

> All SNA should start with plotting your data and calculate basic summaries - if you can plot the network in `R` you can analyse it in `R`
